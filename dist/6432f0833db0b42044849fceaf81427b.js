...
},{"./config":15}],16:[function(require,module,exports) {
'use strict';
...
},{"./config":15,"./positionMethod":14}],11:[function(require,module,exports) {
'use strict';
...
},{"./lookPath":9,"./movePathList":10,"./aniEffectMethod":13,"./positionMethod":14,"./enemyBulletType":16,"./config":15}],12:[function(require,module,exports) {
'use strict';
    ...
    if (_lookPath2.default[this.look](this.position).includes(bulletPs)) {
      ...
      _config.renderData.aniEffect.push((0, _aniEffectMethod.animation)(10, function (renCount, viewDom) {
        _lookPath2.default[this.look](this.position).forEach(function (ps, index) {
          var psObj = (0, _positionMethod.positionToXY)(ps);
          viewDom.beginPath();
          viewDom.rect(psObj.x - _config.pixelWeigth / 2, psObj.y, _config.pixelWeigth + 3, _config.pixelWeigth + 3);
...
},{"./lookPath":9,"./movePathList":10,"./aniEffectMethod":13,"./positionMethod":14,"./config":15}],8:[function(require,module,exports) {
'use strict';
...
function actionMove(ship) {
  ...
  for (var key in keyType) {
    ...
    document.getElementById('debug').innerHTML = JSON.stringify((0, _positionMethod.positionToXY)(_config.renderData.position), null, 2);
  }
}
...
//主角機階段進化
//*主角機物件化？
},{"./js/lookPath":9,"./js/movePathList":10,"./js/createEnemy":11,"./js/createShip":12,"./js/aniEffectMethod":13,"./js/positionMethod":14,"./js/config":15}],17:[function(require,module,exports) {
