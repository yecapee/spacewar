...
},{"./bundle-url":"../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/src/builtins/bundle-url.js"}],"main.css":[function(require,module,exports) {
var reloadCSS = require('_css_loader');

module.hot.dispose(reloadCSS);
module.hot.accept(reloadCSS);
},{"./img/spacebg.png":[["spacebg.0a173b99.png","img/spacebg.png"],"img/spacebg.png"],"_css_loader":"../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/src/builtins/css-loader.js"}],"js/config.js":[function(require,module,exports) {
var atc = {
...
},{}],"js/positionMethod.js":[function(require,module,exports) {
"use strict";
...
exports.xyToPosition = function (x, y) {
  var _x = Math.round(x / _config.pixelWeigth);

  var _y = Math.round(y / _config.pixelWeigth);

  return _y * _config.w + _x;
};
...
},{"./config":"js/config.js"}],"js/lookPath.js":[function(require,module,exports) {
"use strict";
...
function createMapfn(pathArr) {
  return function (ps) {
    ...
    var rs = _toConsumableArray(path.map(function (_xy) {
      return {
        ps: xy(_xy[0], _xy[1]),
        brickType: '0'
      };
...
var _default = {
  ...
  'crystal-plus': function crystalPlus(ps, type) {
    var xy = (0, _positionMethod.ezPositionWithCheckScope)(ps);
    var rs = [];
    var open = type === 'OPEN'; //var open = false;
...
},{"./config":"js/config.js","./positionMethod":"js/positionMethod.js"}],"js/movePathList.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  ...
  gostMove: function gostMove() {
    ...
    var xMargin = Math.floor(margin * r); //console.log(nowY, margin);
  ...
  pingpong: function pingpong() {
    ...
    if (!this.prePosition) {
      ...
      this.position = xy(1, 1); // console.log(this.prePosition,this.position,xy(1, 1));
...
exports.default = _default;
},{"./config":"js/config.js","./positionMethod":"js/positionMethod.js"}],"js/aniEffectMethod.js":[function(require,module,exports) {
"use strict";
...
},{"./config":"js/config.js"}],"js/enemyBulletType.js":[function(require,module,exports) {
"use strict";
...
var _default = {
  normal: function normal(bulletPs, ship) {
    var time = 45;
    var prePs = bulletPs;
    var count = time;

    var dataFn = function dataFn(taPs, clear) {
      count--;
  ...
  track: function track(bulletPs, ship) {
    var prePs = bulletPs;
    var time;
    var count;
    var p1 = null;
  ...
  diffusionTrack: function diffusionTrack(bulletPs, ship) {
    for (var i = 0; i < 3; i++) {
      (function (i) {
        //console.log('i',i);
        var prePs = bulletPs;
        ...
        var dataFn = function dataFn(taPs, clear) {
          ...
          return {
            ...
            w: 15,
            h: 15,
            clear: count < -5 || (0, _positionMethod.xyToPosition)(x, y).x < 0 || (0, _positionMethod.xyToPosition)(x, y).x > _config.w - 1
          };
        };
...
exports.default = _default;
},{"./config":"js/config.js","./positionMethod":"js/positionMethod.js","./aniEffectMethod":"js/aniEffectMethod.js"}],"js/skillPath.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./config":"js/config.js","./positionMethod":"js/positionMethod.js"}],"js/bricks.js":[function(require,module,exports) {
"use strict";
...
function _default(brickObj, viewDom, color) {
  if (!brickObj) return;
...
},{"./positionMethod":"js/positionMethod.js","./config":"js/config.js"}],"js/enemySkillType.js":[function(require,module,exports) {
"use strict";
...
var _skillPath = _interopRequireDefault(require("./skillPath"));

var _bricks = _interopRequireDefault(require("./bricks"));
...
function circle(x, y, r, all, now, margin) {
  ...
  return {
    ...
    position: (0, _positionMethod.sXsYToPosition)(_x, _y),
    outScope: Math.round(_x / _config.pixelWeigth) < 0 || Math.round(_x / _config.pixelWeigth) > _config.w - 1 || Math.round(_y / _config.pixelWeigth) < 0 || Math.round(_y / _config.pixelWeigth) > _config.h - 1,
    x: _x,
    y: _y
  };
}
...
var _default = {
  claw: function claw(position, ship) {
    var time = 60;
    var prePs = position;
    var count = time;
    ...
    return function (ship, viewDom) {
      ...
      if (count > time * .9) {
        _skillPath.default['claw1'](_taPs).forEach(function (ps) {
          (0, _bricks.default)(ps, viewDom, 'rgba(255,255,255,.8)');
        });
      ...
      if (count > time * .8) {
        _skillPath.default['claw2'](_taPs).forEach(function (ps) {
          (0, _bricks.default)(ps, viewDom, 'rgba(255,255,255,.2)');
        });
      ...
      if (count > time * .6) {
        _skillPath.default['claw3'](_taPs).forEach(function (ps) {
          (0, _bricks.default)(ps, viewDom, 'rgba(255,255,255,.6)');
      ...
      if (count > time * .4) {
        _skillPath.default['claw4'](_taPs).forEach(function (ps) {
          (0, _bricks.default)(ps, viewDom, 'rgba(255,255,255,.6)');
          isHurt = isHurt || ship.path.includes(ps.ps);
        });
      ...
      if (count > 0) {
        _skillPath.default['claw5'](_taPs).forEach(function (ps) {
          (0, _bricks.default)(ps, viewDom, 'rgba(255,255,255,1.0)');
          isHurt = isHurt || ship.path.includes(ps.ps);
        });
  ...
  atomicExplosion: function atomicExplosion(position, ship) {
    var time = 300 - (40 - _config.w) * 20;
    var prePs = position;
    var count = time;
    var _taPs = ship.position;
    return function (ship, viewDom) {
      ...
      skillPath.forEach(function (ps) {
        ...
        var color = 'rgba(' + Math.round(255 - 200 / time * (time - count)) + ',80,' + Math.round(50 + 205 / time * (time - count)) + ',' + (count / time * .5 + .5).toFixed(1) + ')'; //bricks(ps, viewDom, 'blue');
...
exports.default = _default;
},{"./config":"js/config.js","./positionMethod":"js/positionMethod.js","./skillPath":"js/skillPath.js","./bricks":"js/bricks.js","./aniEffectMethod":"js/aniEffectMethod.js"}],"node_modules/tone/build/Tone.js":[function(require,module,exports) {
var define;
...
exports.deadSound = deadSound;
exports.explosionSound = explosionSound;

var _tone = _interopRequireDefault(require("tone"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var synth = new _tone.default.FMSynth().toMaster();
...
var noise = new _tone.default.Noise({
  "volume": -Infinity,
  "type": "brown",
  "fadeIn": 500000,
  "fadeOut": 400
...
var autoFilter = new _tone.default.AutoFilter({
  "frequency": ".5",
  "min": 800,
  "max": 15000
}).toMaster();
...
},{"tone":"node_modules/tone/build/Tone.js"}],"js/createEnemy.js":[function(require,module,exports) {
"use strict";
...
var _lookPath = _interopRequireDefault(require("./lookPath"));

var _movePathList = _interopRequireDefault(require("./movePathList"));

var _aniEffectMethod = require("./aniEffectMethod");

var _positionMethod = require("./positionMethod");

var _enemyBulletType = _interopRequireDefault(require("./enemyBulletType"));

var _enemySkillType = _interopRequireDefault(require("./enemySkillType"));
...
function enemyMove() {
  if (_movePathList.default[this.movePath] && this.getST() % this.moveTime == 0) _movePathList.default[this.movePath].call(this);
}

function shotByEnemy(position, bulletType, ship) {
  //var bulletArr = renderData.enemyBullet;
  //var dataFn = 
  _enemyBulletType.default[bulletType](position, ship); // if (!bulletArr.reduce(function (rs, el) { return rs || (el.data.position === position) }, false)) {
  //   bulletArr.push({
  //     data: dataFn(ship.position),
  //     fn: dataFn,
  //   })
...
function launchSkillsByEnemy(position, Type, ship) {
  ...
  var skillArr = _config.renderData.skills.push(_enemySkillType.default[Type](position, ship)); // var dataFn = bulletTypeMap[bulletType](position);
...
function _default(obj) {
  ...
  this.wasHit = function (bulletPs, viewDom, cb) {
    ...
    var path = _lookPath.default[this.look](this.position).map(function (el) {
      return el.ps;
    });
  ...
  this.grapic = function (viewDom, lootype) {
    ...
    _lookPath.default[this.look](this.position).forEach(function (ps, index) {
      (0, _bricks.default)(ps, viewDom, color);
    });

    if (this.showLife) {
      var ps = (0, _positionMethod.positionToXY)(this.lifeBarPosition(this.position));
...
},{"./lookPath":"js/lookPath.js","./movePathList":"js/movePathList.js","./aniEffectMethod":"js/aniEffectMethod.js","./positionMethod":"js/positionMethod.js","./enemyBulletType":"js/enemyBulletType.js","./enemySkillType":"js/enemySkillType.js","./bricks":"js/bricks.js","./sound":"js/sound.js","./config":"js/config.js"}],"js/script.js":[function(require,module,exports) {
"use strict";
...
var _createEnemy = _interopRequireDefault(require("./createEnemy"));
...
var GOZILLA = {
  name: "GOZILLA",
  showLife: true,
  lifeBarPosition: function lifeBarPosition(ps) {
    var xy = (0, _positionMethod.ezPositionWithCheckScope)(ps);
    return xy(0, -9);
  },
  life: 800,
  ...
  skills: [{
    ...
    skillPoint: function skillPoint(ps) {
      var xy = (0, _positionMethod.ezPositionWithCheckScope)(ps);
      var point = [[-5, -2]];
  ...
  shotPoint: function shotPoint(ps) {
    var xy = (0, _positionMethod.ezPositionWithCheckScope)(ps);
...
var GOZILLA2 = {
  ...
  look: "MONSTER1",
  shotLook: "MONSTER1_openmouth",
  position: Math.round(_config.w / 3) * 2 - 5,
  bulletType: "track",
  skills: [{
    type: "atomicExplosion",
    launchTime: [250, 120, 6],
...
var script = {
  ...
  2400: {
    item: [hp_1, GreenPoint, GreenPoint, GreenPoint, GreenPoint, GreenPoint, GreenPoint, GreenPoint]
  },
  2401: {
...
function _default(renCount, ruleObj, nextPolling) {
...
},{"./config":"js/config.js","./createEnemy":"js/createEnemy.js","./aniEffectMethod":"js/aniEffectMethod.js","./positionMethod":"js/positionMethod.js"}],"js/shipBulletType.js":[function(require,module,exports) {
"use strict";
...
exports.default = _default;
},{"./config":"js/config.js","./positionMethod":"js/positionMethod.js"}],"js/createShip.js":[function(require,module,exports) {
"use strict";
...
var _shipBulletType = _interopRequireDefault(require("./shipBulletType"));
...
function grapicBullet(viewDom) {
  ...
  thisBullet.map(function (el) {
    ...
    viewDom.drawImage(bulletImg, el.data.x - 13 / 2, el.data.y - 5, 13, 64); // defense
...
function _default(obj) {
  ...
  this.shotFps = 8;
  this.maxLife = obj.life;
  this.path = _lookPath.default[this.look](this.position, this.lookType).map(function (el) {
    return el.ps;
  });
  this.pathObj = _lookPath.default[this.look](this.position, this.lookType);
  ...
  this.injured = function () {
    ...
    _config.renderData.aniEffect.push((0, _aniEffectMethod.animation)(10, function (renCount, viewDom) {
      this.pathObj.forEach(function (ps, index) {
        (0, _bricks.default)(ps, viewDom, 'rgba(255,0,0,.8)');
      });
    }.bind(this)));
  ...
  this.shot = function () {
    if (!this.isDead) {
      //
      _shipBulletType.default[this.bulletType](this.position, this.bullet); //
  ...
  this.grapic = function (viewDom) {
    ...
    var path = _lookPath.default[this.look](this.position, this.lookType).map(function (el) {
      return el.ps;
    });

    var pathObj = _lookPath.default[this.look](this.position, this.lookType);
    ...
    if (!isDead) {
      _lookPath.default[this.look](this.position, this.lookType).forEach(function (ps, index) {
        (0, _bricks.default)(ps, viewDom);
      }); // touchEnemy


      var enemyMap = _config.renderData.enemy.reduce(function (total, el) {
        return [].concat(_toConsumableArray(total), _toConsumableArray(_lookPath.default[el.look](el.position).map(function (el) {
          return el.ps;
        })));
      }, []);
      ...
      _config.renderData.item.forEach(function (item, index) {
        var itemMap = _lookPath.default[item.look](item.position).map(function (el) {
          return el.ps;
        });
  ...
  this.dead = function () {
    ...
    _config.renderData.aniEffect.push((0, _aniEffectMethod.animation)(50, function (renCount, viewDom) {
      viewDom.drawImage(explosion, deadPs.x - (50 - renCount) / 2, deadPs.y, 120 - renCount, 120 - renCount); //console.log(renCount);
...
},{"./lookPath":"js/lookPath.js","./movePathList":"js/movePathList.js","./shipBulletType":"js/shipBulletType.js","./aniEffectMethod":"js/aniEffectMethod.js","./bricks":"js/bricks.js","./sound":"js/sound.js","./positionMethod":"js/positionMethod.js","./config":"js/config.js"}],"js/createItem.js":[function(require,module,exports) {
"use strict";
...
function _default(obj) {
  ...
  this.wasPickUp = function (ship) {
    ...
    var changeBullet = this.changeBullet; // restoreLife
...
},{"./lookPath":"js/lookPath.js","./movePathList":"js/movePathList.js","./aniEffectMethod":"js/aniEffectMethod.js","./positionMethod":"js/positionMethod.js","./config":"js/config.js","./bricks":"js/bricks.js"}],"index.js":[function(require,module,exports) {
"use strict";

require("./main.css");

var _lookPath = _interopRequireDefault(require("./js/lookPath"));

var _movePathList = _interopRequireDefault(require("./js/movePathList"));

var _script = _interopRequireDefault(require("./js/script"));

var _createEnemy = _interopRequireDefault(require("./js/createEnemy"));

var _createShip = _interopRequireDefault(require("./js/createShip"));

var _createItem = _interopRequireDefault(require("./js/createItem"));
...
function clearRenderData() {
  ...
  _config.renderData.boss = []; // renderData.enemyBullet = [];
  // renderData.aniEffect = [];

  _config.renderData.item = [];
  _config.renderData.skills = []; //console.log(renderData);
}

var ship = new _createShip.default({
  name: 'CrystalShip',
...
function gaphic(TYPE) {
  ...
  var stopCount = ruleObj.stopCount,
      stopEnemyPush = ruleObj.stopEnemyPush;
  var boss = ruleObj.boss || [];
  (0, _script.default)(scriptMileage, ruleObj, nextPolling);

  if (TYPE === 'OBJ_MOVE') {
    var createObj = false;
    var item = ruleObj.item; // enemy push
    ...
    if (renCount == nextPolling && !stopEnemyPush) {
      for (var x = 0; x < ruleObj.enemyQuantity; x++) {
        ...
        if (enemyObj) {
          ...
          _config.renderData.enemy.push(new _createEnemy.default(enemyObj));
        }
      }
    ...
    if (item) {
      item.forEach(function (itemData) {
        ...
        _config.renderData.item.push(new _createItem.default(itemData));
      });
      ruleObj.item = null;
    }
  ...
  viewDom.clearRect(0, 0, _config.vwidth, _config.vheight); // ship

  ship.grapic(viewDom); //enmyBullet
  ...
  _config.renderData.skills.forEach(function (skill, index) {
    skill(ship, viewDom) && _config.renderData.skills.splice(index, 1);
  }); // item
...
function step(timestamp) {
  ...
  if (progress >= _config.renderTime) {
    preTimetamp = timestamp; //animation
...
// 加入近戰道具
// 玩家特殊技
},{"./main.css":"main.css","./js/lookPath":"js/lookPath.js","./js/movePathList":"js/movePathList.js","./js/script":"js/script.js","./js/createEnemy":"js/createEnemy.js","./js/createShip":"js/createShip.js","./js/createItem":"js/createItem.js","./js/aniEffectMethod":"js/aniEffectMethod.js","./js/positionMethod":"js/positionMethod.js","./js/config":"js/config.js"}],"../../.nvm/versions/node/v10.16.3/lib/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
//# sourceMappingURL=/spacewar.e31bb0bc.js.map