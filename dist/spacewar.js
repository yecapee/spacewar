...
},{"./bundle-url":26}],9:[function(require,module,exports) {

        var reloadCSS = require('_css_loader');
        module.hot.dispose(reloadCSS);
        module.hot.accept(reloadCSS);
      
},{"./img/spacebg.png":[["21b8e1d576e52bb748c5ee8b4b661590.png",20],20],"_css_loader":19}],18:[function(require,module,exports) {
var atc = {
...
},{"./config":18}],10:[function(require,module,exports) {
'use strict';
...
function createMapfn(pathArr) {
  return function (ps) {
    ...
    var path = pathArr;
    var rs = [].concat(_toConsumableArray(path.map(function (_xy) {
...
},{"./config":18,"./positionMethod":17}],16:[function(require,module,exports) {
'use strict';
...
},{"./config":18}],21:[function(require,module,exports) {
'use strict';
...
},{"./config":18,"./positionMethod":17}],27:[function(require,module,exports) {
'use strict';
...
},{"./config":18,"./positionMethod":17}],23:[function(require,module,exports) {
'use strict';
...
},{"./positionMethod":17,"./config":18}],22:[function(require,module,exports) {
'use strict';
...
var _skillPath2 = _interopRequireDefault(_skillPath);
...
exports.default = {
  claw: function claw(position, ship) {
    ...
    return function (ship, viewDom) {
      ...
      if (count > time * .9) {
        _skillPath2.default['claw1'](_taPs).forEach(function (ps) {
          (0, _bricks2.default)(ps, viewDom, 'rgba(255,255,255,.8)');
        });
        return false;
      }
      if (count > time * .8) {
        _skillPath2.default['claw2'](_taPs).forEach(function (ps) {
          (0, _bricks2.default)(ps, viewDom, 'rgba(255,255,255,.2)');
        });
        return false;
      }
      if (count > time * .6) {
        _skillPath2.default['claw3'](_taPs).forEach(function (ps) {
          (0, _bricks2.default)(ps, viewDom, 'rgba(255,255,255,.6)');
      ...
      if (count > time * .4) {
        _skillPath2.default['claw4'](_taPs).forEach(function (ps) {
          (0, _bricks2.default)(ps, viewDom, 'rgba(255,255,255,.6)');
          isHurt = isHurt || ship.path.includes(ps.ps);
        });
        if (isHurt) ship.injured();
      ...
      if (count > 0) {
        _skillPath2.default['claw5'](_taPs).forEach(function (ps) {
          (0, _bricks2.default)(ps, viewDom, 'rgba(255,255,255,1.0)');
          isHurt = isHurt || ship.path.includes(ps.ps);
        });
        if (isHurt) ship.injured();
        return false;
...
},{"./config":18,"./positionMethod":17,"./skillPath":27,"./bricks":23,"./aniEffectMethod":16}],28:[function(require,module,exports) {
...
var synth = new _tone2.default.FMSynth().toMaster();
...
var noise = new _tone2.default.Noise({
  "volume": -Infinity,
  "type": "brown",
  "fadeIn": 500000,
  "fadeOut": 400
...
//make an autofilter to shape the noise
var autoFilter = new _tone2.default.AutoFilter({
  "frequency": ".5",
  "min": 800,
  "max": 15000
}).toMaster();
...
},{"tone":28}],13:[function(require,module,exports) {
'use strict';
...
exports.default = function (obj) {
  ...
  this.wasHit = function (bulletPs, viewDom, cb) {
    var me = this;
    var path = _lookPath2.default[this.look](this.position).map(function (el) {
      return el.ps;
    });
  ...
  this.grapic = function (viewDom, lootype) {
    ...
    _lookPath2.default[this.look](this.position).forEach(function (ps, index) {
      (0, _bricks2.default)(ps, viewDom, color);
    });
  };
...
var _enemySkillType2 = _interopRequireDefault(_enemySkillType);
...
function launchSkillsByEnemy(position, Type, ship) {
  ...
  var skillArr = _config.renderData.skills.push(_enemySkillType2.default[Type](position, ship));
...
},{"./lookPath":10,"./movePathList":11,"./aniEffectMethod":16,"./positionMethod":17,"./enemyBulletType":21,"./enemySkillType":22,"./bricks":23,"./sound":24,"./config":18}],12:[function(require,module,exports) {
'use strict';
...
//export 
;
},{"./config":18,"./createEnemy":13,"./aniEffectMethod":16,"./positionMethod":17}],25:[function(require,module,exports) {
'use strict';
...
exports.default = function (obj) {
  ...
  this.path = _lookPath2.default[this.look](this.position, this.lookType).map(function (el) {
    return el.ps;
  });
  this.pathObj = _lookPath2.default[this.look](this.position, this.lookType);
  ...
  this.grapic = function (viewDom) {
    ...
    if (!isDead) {
      ...
      var enemyMap = _config.renderData.enemy.reduce(function (total, el) {
        return [].concat(_toConsumableArray(total), _toConsumableArray(_lookPath2.default[el.look](el.position).map(function (el) {
          return el.ps;
        })));
      }, []);
      ...
      _config.renderData.item.forEach(function (item, index) {
        var itemMap = _lookPath2.default[item.look](item.position).map(function (el) {
          return el.ps;
        });
...
},{"./lookPath":10,"./movePathList":11,"./shipBulletType":25,"./aniEffectMethod":16,"./bricks":23,"./sound":24,"./positionMethod":17,"./config":18}],15:[function(require,module,exports) {
'use strict';
...
},{"./lookPath":10,"./movePathList":11,"./aniEffectMethod":16,"./positionMethod":17,"./config":18,"./bricks":23}],2:[function(require,module,exports) {
'use strict';
...
function gaphic(TYPE) {
  ...
  (0, _script2.default)(scriptMileage, ruleObj, nextPolling);
  if (TYPE === 'OBJ_MOVE') {
    var createObj = false;
...
// 加入近戰道具
// 玩家特殊技
},{"./main.css":9,"./js/lookPath":10,"./js/movePathList":11,"./js/script":12,"./js/createEnemy":13,"./js/createShip":14,"./js/createItem":15,"./js/aniEffectMethod":16,"./js/positionMethod":17,"./js/config":18}],29:[function(require,module,exports) {
